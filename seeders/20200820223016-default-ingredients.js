...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Ingredients', [
      ...
      { recipeId: 4, amount: 1, measurementUnitId: 15, foodStuff: 'vinegar', createdAt: new Date(), updatedAt: new Date() },
      ...
      { recipeId: 2, amount: 2, measurementUnitId: 15, foodStuff: 'bread, your favorite kind', createdAt: new Date(), updatedAt: new Date() },
